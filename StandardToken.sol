...
contract Token {
    ...
    uint256 public totalSupplyForCalculation;
...
contract StandardToken is Token {
     ...
     * @dev The function SHOULD revert() if the _from account balance does not have enough tokens to spend.
     *
     ...
     * @dev sub-currencies. The function SHOULD revert() unless the _from account has deliberately authorized the sender of
